namespace IDP.Const
{
    public sealed class ErrorStatus
    {
        ...
        public const string STATUS_MSG_INSUFFICIENT_PRIVILEGES = "Insufficient Privileges";
        ...
        private void initStatusList()
        {
            StatusList = new List<KeyValuePair<string, int>>
            {
                ...
                new KeyValuePair<string, int>(STATUS_MSG_INSUFFICIENT_PRIVILEGES, STATUS_CODE_UNAUTHORIZED)
            };
        }
    }
}
